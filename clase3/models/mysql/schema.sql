...
CREATE TABLE movie_genre (
	movie_id BINARY(16) NOT NULL REFERENCES movie(id),
...
(UUID_TO_BIN(UUID()), 'The Avengers', 2012, 'Joss Whedon', 143, 'https://img.fruugo.com/product/7/41/14532417_max.jpg', 8),
